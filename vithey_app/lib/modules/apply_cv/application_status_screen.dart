...
import 'package:aub_connect_app/modules/apply_cv/widgets/application_status_widgets.dart';
          ...
          child: ListView(
            ...
            children: [
              ...
              if (Get.find<FeatureFlags>().showMockDevTools && kDebugMode) ...[
                ...
                TextButton(
                  onPressed: controller.cycleMockStatus,
                  child: const Text('Demo: cycle status (mock only)'),
                ),
              ],
            ],
          ),
