...
class NotificationTypeBadge extends StatelessWidget {
  ...
  static Color colorFor(NotificationType type) {
    return switch (type) {
      ...
      NotificationType.postComment || NotificationType.postMention => const Color(0xFF2196F3),
      NotificationType.postShare => AppColors.primary,
      NotificationType.newFollower => AppColors.success,
      NotificationType.jobApplicationReceived || NotificationType.jobApplicationStatus => const Color(0xFFFF9800),
      NotificationType.chatRequest || NotificationType.chatMessage => AppColors.primary,
  ...
  static IconData iconFor(NotificationType type) {
    return switch (type) {
      ...
      NotificationType.postComment || NotificationType.postMention => Icons.mode_comment,
      NotificationType.postShare => Icons.share,
      NotificationType.newFollower => Icons.person_add,
      NotificationType.jobApplicationReceived || NotificationType.jobApplicationStatus => Icons.work_outline,
      NotificationType.chatRequest || NotificationType.chatMessage => Icons.chat_bubble,
      NotificationType.paymentDue || NotificationType.paymentOverdue => Icons.payments,
