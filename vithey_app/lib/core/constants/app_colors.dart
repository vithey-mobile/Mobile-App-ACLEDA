...
class AppColors {
  ...
  static const splashWaveLight = Color(0xFF2EC4B6);
  static const splashTextWhite = Color(0xFFFFFFFF);
  static const splashCircleWhite = Color(0xFFFFFFFF);

  static const splashBackground = splashBaseTeal;
  static const splashAccent = splashWaveLight;

  static const onboardingTeal = Color(0xFF00BFA5);
  static const onboardingTealDark = Color(0xFF1A9B8E);
  static const onboardingTitle = Color(0xFF37474F);
  static const onboardingBody = Color(0xFF78909C);
  static const onboardingDotActive = Color(0xFF00BFA5);
  static const onboardingDotInactive = Color(0xFFCFD8DC);
