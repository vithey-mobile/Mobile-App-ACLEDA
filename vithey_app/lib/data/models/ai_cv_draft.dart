...
class AiCvDraft {
  ...
  factory AiCvDraft.fromJson(Map<String, dynamic> json) {
    ...
    final contact = json['contact']?.toString() ?? '';
    ...
    return AiCvDraft(
      ...
      references: asStringList(json['references']),
      certifications: asStringList(json['certifications']),
      achievements: asStringList(json['achievements']),
      hobbies: asStringList(json['hobbies']),
      softSkills: asStringList(json['soft_skills'] ?? json['softSkills']),
      templateId: json['template_id']?.toString() ?? json['templateId']?.toString(),
      incompleteProfile:
          json['incomplete_profile'] as bool? ??
          json['incompleteProfile'] as bool? ??
          false,
      incompleteMessage: json['incomplete_message']?.toString() ??
          json['incompleteMessage']?.toString(),
    );
  }
