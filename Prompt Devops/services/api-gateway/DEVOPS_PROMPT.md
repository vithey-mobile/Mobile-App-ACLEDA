...
```text
vithey-backend/docker-compose.api-gateway.yml
...
- `vithey-backend/config-repo/api-gateway.yml`
- `vithey-backend/docker-compose.api-gateway.yml`
- `.github/workflows/api-gateway-ci.yml`

CI must run Maven tests, build the Docker image with `SERVICE_PORT=8080`, and validate `docker-compose.api-gateway.yml`.
