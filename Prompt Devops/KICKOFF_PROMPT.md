...
| Eureka Server | `vithey-backend/eureka-server` | `ghcr.io/<owner>/vithey-eureka-server` |
| Config Server | `vithey-backend/config-server` | `ghcr.io/<owner>/vithey-config-server` |
