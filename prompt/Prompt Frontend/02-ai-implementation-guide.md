...
- Backend: Java 21, Spring Boot 3+, one runnable service per folder under vithey-backend/services/ — **except ai-service (Python 3.12 + FastAPI)**
...
|-------|---------------|------|
| 1 | `Prompt Backend/infrastructure/` | 8761, 8888 |
...
| 11 | `Prompt Backend/services/ai-service/` | 8089 (**Python FastAPI**) |
