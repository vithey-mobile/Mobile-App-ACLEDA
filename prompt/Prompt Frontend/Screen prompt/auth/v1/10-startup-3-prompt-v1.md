# 10 - Start Up 3 / Discovery Source Prompt (v1)
...
> Pair with `v1/08-startup-1-prompt-v1.md` and `v1/09-startup-2-prompt-v1.md`.  
...
| Field | Value |
|---|---|
| Screen ID | `10` (v1) / legacy `03G` / Start Up step 3 of 3 |
...
- `v1/08-startup-1-prompt-v1.md`
- `v1/09-startup-2-prompt-v1.md`
