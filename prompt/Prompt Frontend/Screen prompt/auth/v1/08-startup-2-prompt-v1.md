# 08 - Start Up 2 / Interests Selection Prompt (Version 2)
...
> **Pair with** `07-startup-1-prompt-version-2.md` and `09-startup-3-prompt-version-2.md`.  
...
| Field | Value |
| --- | --- |
| Screen ID | `08` (v2) / legacy `03F` / Start Up step 2 of 3 |
