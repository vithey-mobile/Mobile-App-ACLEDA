...
> Full standalone v1 prompt. Visual source of truth: `Select Language Screen.png`.
...
| Prompt | `Screen prompt/auth/v1/02-select-language-prompt-v1.md` |
...
App launch
    → Splash
    → Select Language   ← this screen (once / until language saved)
...
```
┌─────────────────────────────────────┐
│  Skip                          →    │  Top-right, on teal header
│         [ teal wave header ]        │  Organic waves into white body
├─────────────────────────────────────┤
│         Select Language             │  Bold, centered, dark
│  Choose your preferred language     │  Muted secondary, centered
│         for the app.                │
│  ┌───────────────────────────────┐  │
│  │ 🇺🇸 English (US)          ✓  │  │  Selected: teal check
│  │    English                    │  │
│  ├───────────────────────────────┤  │
│  │ 🇰🇭 Khmer                    │  │
│  │    ភាសាខ្មែរ                 │  │
│  └───────────────────────────────┘  │
│            ● ○ ○ ○                  │  4 dots; first active (teal)
│                                     │
│      [ 🌐 Apply Language ]          │  Primary teal CTA + globe icon
└─────────────────────────────────────┘
```
...
| Row layout | Circular flag (left) · title + native subtitle (center) · trailing check if selected (right) |
...
| `km` | Khmer | ភាសាខ្មែរ | `khmer_language.png` | No |
...
- `v1/01-splash-prompt-v1.md` (routing update)
- `v1/03-onboarding-prompt-v1.md` (next first-launch screen)
