...
> **Pair with** `v1/04-auth-prompt-v1.md` — Sign Up is **not** a separate background system; it is a **panel inside the same Auth screen** that morphs (grow/shrink) with Sign In.  
