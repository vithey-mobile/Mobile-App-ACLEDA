# 10 - Start Up 3 / Discovery Source Prompt
...
> Pair with `08-startup-1-prompt.md` and `09-startup-2-prompt.md`.  
...
| Field | Value |
|---|---|
| Screen ID | `10` / legacy `03G` / Start Up step 3 of 3 |
...
- Both directions must feel natural. Prefer the same clipped-lane pattern used for Auth register Part 1 â†” Part 2.
...
3. **Single-choice option list** — five full-width rounded selection rows:
   - Leading icon Â· bold/medium label Â· trailing radio
...
5. **Bottom step navigation** (fixed shell) — Back Â· three teal dots (step 3 of 3) Â· teal **Next**  
