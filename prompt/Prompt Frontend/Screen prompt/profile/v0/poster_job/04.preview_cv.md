# 04 — Applicant CV Preview and Application Review
...
Use the shared secure `CvDocumentViewer` also used by `../09.preview_own_cv.md`, with different authorization/download policies.
